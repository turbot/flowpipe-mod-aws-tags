trigger "query" "detect_and_correct_elastic_beanstalk_environments_with_incorrect_tags" {
  ...
  sql      = local.elastic_beanstalk_environments_with_incorrect_tags_query
...
variable "elastic_beanstalk_environments_tag_rules" {
  type = object({
  ...
  description = "Elastic Beanstalk Environment specific tag rules"
  default     = null
  tags = {
...
variable "elastic_beanstalk_environments_with_incorrect_tags_trigger_enabled" {
  type        = bool
  default     = false
...
variable "elastic_beanstalk_environments_with_incorrect_tags_trigger_schedule" {
  type        = string
  default     = "15m"
